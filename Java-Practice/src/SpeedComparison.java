...
public class SpeedComparison {
    public static void main(String[] args) {
        ...
        System.out.println("순서대로 추가 - ArrayList : " + Math.round((endTime - startTime) / 1000000 * 100) / 100.0 + "ms");

        startTime = System.nanoTime();
        for (int i = 1; i <= 10000000; i++) linkedList.add(i);
        endTime = System.nanoTime();
        System.out.println("순서대로 추가 - LinkedList : " + Math.round((endTime - startTime) / 1000000 * 100) / 100.0 + "ms");
