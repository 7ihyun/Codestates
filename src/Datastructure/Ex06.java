...
public class Ex06 {
    ...
    private ArrayList<Ex06> children;

    public Ex06() {	//전달인자가 없을 경우의 생성자
        this.value = null;
        this.children = null;
    }
    public Ex06(String data) {	//전달인자가 존재할 경우의 생성자
        this.value = data;
        this.children = null;
    }
    ...
    public void addChildNode(Ex06 node) {
        if(children == null) children = new ArrayList<>();
        children.add(node);
    }
    public void removeChildNode(Ex06 node) {
    ...
    public ArrayList<Ex06> getChildrenNode() {
        return children;
    }
